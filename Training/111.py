...
# всё вышесказанное связано с тем, что консоль не воспринимает некоторые принты, но  их понимает терминал.
# в дальнейшем всеравно с этим столкнёмся, когда будем писать программы под терминал, это всё ещё будет
